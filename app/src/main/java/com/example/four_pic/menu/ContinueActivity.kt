...
class ContinueActivity : AppCompatActivity() {
    private lateinit var binding: com.example.four_pic.databinding.ActivityContinueBinding
...
//                custom()
        ...
        binding.btnHelp.setOnClickListener {
            if (gameManager.coins>=5) {
                ...
                Toast.makeText(this@ContinueActivity, "Tangalaringiz miqdori yetmaydi", Toast.LENGTH_SHORT).show()
            }
...
//                startActivity(Intent(this@MainActivity, MenuActivity::class.java))
    ...
    private fun custom() {
        val alertDialog: AlertDialog.Builder = AlertDialog.Builder(this@ContinueActivity,
